...
- `driver-ai-agent-2026` | `driver` | insufficient=1 | tags=insufficient_but_sounds_final, reflect_false_insufficient
...
- 详细运行记录：`evals\eval_runs\20260328_051909_baseline-definition-llm.json`
...
- 详细运行记录：`evals\eval_runs\20260328_051909_driver-ai-agent-2026.json`
...
- `general` | `enough` | 为什么 2026 年 AI Agent 会加速落地？ 当前常见的表现、案例或实际情况有哪些？
  原因：当前结果不只是相关，而且已经较明确地回答了这道子问题，可以进入总结阶段。
- `risk` | `insufficient` | 为什么 2026 年 AI Agent 会加速落地？ 还存在哪些争议、限制或值得继续研究的点？
  原因：当前材料与主题相关，但还没有真正把主要风险、限制或治理问题讲清楚。
...
- `insufficient` 数量：0
- 失败标签：no_obvious_failure
- 详细运行记录：`evals\eval_runs\20260328_051909_selector-noise-english-learning-app.json`
...
- `insufficient` 数量：0
- 失败标签：no_obvious_failure
- 详细运行记录：`evals\eval_runs\20260328_051909_timeline-solid-state-battery.json`
...
- `insufficient` 数量：1
- 失败标签：insufficient_but_sounds_final, reflect_false_insufficient
- 详细运行记录：`evals\eval_runs\20260328_051909_complex-ai-agent-employment.json`
