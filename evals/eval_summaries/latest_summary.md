# Eval Summary 20260328_053335

- 测试题数量：5
- 出现 `insufficient` 的题目数量：1
...
- `timeline-solid-state-battery` | `timeline-trend` | insufficient=0 | tags=no_obvious_failure
...
- 详细运行记录：`evals\eval_runs\20260328_053335_baseline-definition-llm.json`
...
- `insufficient` 数量：0
- 失败标签：no_obvious_failure
- 详细运行记录：`evals\eval_runs\20260328_053335_driver-ai-agent-2026.json`
...
- `insufficient` 数量：0
- 失败标签：no_obvious_failure
- 详细运行记录：`evals\eval_runs\20260328_053335_selector-noise-english-learning-app.json`
...
- `insufficient` 数量：0
- 失败标签：no_obvious_failure
- 详细运行记录：`evals\eval_runs\20260328_053335_timeline-solid-state-battery.json`
...
- 详细运行记录：`evals\eval_runs\20260328_053335_complex-ai-agent-employment.json`
