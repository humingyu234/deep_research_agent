...
- 详细运行记录：`evals\eval_runs\20260328_050932_baseline-definition-llm.json`
...
- `insufficient` 数量：0
- 失败标签：no_obvious_failure
- 详细运行记录：`evals\eval_runs\20260328_050932_driver-ai-agent-2026.json`
...
- `insufficient` 数量：0
- 失败标签：no_obvious_failure
- 详细运行记录：`evals\eval_runs\20260328_050932_selector-noise-english-learning-app.json`
...
- `insufficient` 数量：0
- 失败标签：no_obvious_failure
- 详细运行记录：`evals\eval_runs\20260328_050932_timeline-solid-state-battery.json`
...
- `insufficient` 数量：0
- 失败标签：no_obvious_failure
- 详细运行记录：`evals\eval_runs\20260328_050932_complex-ai-agent-employment.json`
